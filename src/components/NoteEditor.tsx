  ...
  return (
    <>
      <button
        ...
        className="magnetic-btn inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-xl border border-amber-500/30 bg-amber-500/5 text-amber-700 hover:bg-amber-500/15 hover:text-amber-800 transition-all duration-200 dark:text-amber-300 dark:hover:text-amber-200"
        title="Preview Note"
      >
