      ...
      <div className="flex items-center justify-between gap-3 md:gap-6 px-3 sm:px-5 py-3">
        <Link to="/" className="flex items-center gap-2 pb-1 min-w-0 shrink-0 group">
          <img
            ...
            decoding="sync"
            fetchPriority="high"
            className="h-[1.51rem] w-[1.51rem] sm:h-[1.73rem] sm:w-[1.73rem] object-contain shrink-0 transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-6"
          />
