          ...
          {!collapsed ? (
            ...
            >
              <motion.img
                ...
                className="h-[1.5rem] w-[1.5rem] object-contain flex-shrink-0"
            ...
            >
              ...
              >
                <img
                  src="/logo.png"
                  alt="Notebook Archive"
                  className="absolute h-[1.5rem] w-[1.5rem] object-contain transition-all duration-300 group-hover:opacity-0 group-hover:scale-75 group-hover:rotate-[-8deg]"
                />
