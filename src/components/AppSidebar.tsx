      ...
      <div className="flex items-center justify-between p-3 border-b border-sidebar-border">
        <AnimatePresence>
          {!collapsed && (
            ...
            >
              <img src="/favicon.png" alt="Notebook Archive" className="h-7 w-7 object-contain flex-shrink-0" />
              <span className="font-serif font-bold text-foreground text-base whitespace-nowrap leading-none">Notebook Archive</span>
              <Link
                to="/"
