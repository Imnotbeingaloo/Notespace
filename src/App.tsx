...
const BlogAIStudyTools = lazy(() => import("./pages/BlogAIStudyTools"));
            ...
            <AuthProvider>
              ...
              <Routes>
               ...
               <Route path="/reset-password" element={<ResetPasswordPage />} />
                ...
                <Route path="/blog/ai-study-tools" element={<Suspense fallback={<BlogSkeleton />}><BlogAIStudyTools /></Suspense>} />
