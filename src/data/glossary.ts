...
export const GLOSSARY: GlossaryEntry[] = [
  {
    ...
    body: [
      ...
      "Modern Zettelkasten lives in apps like Obsidian, Roam, and Notespace. The mechanics are simpler now (you don't need to handwrite IDs), but the discipline is the same: atomic notes, your own words, explicit links.",
  ...
  },
  {
    ...
    body: [
      ...
      "Notespace ships a Cornell template you can open with one click. The cue column is a callout block, the summary is a horizontal rule and short paragraph at the bottom.",
    ],
  ...
  },
  {
    ...
    body: [
      ...
      "Notespace is intentionally narrow PKM: notebooks, notes, tags, search. No databases, no relations, no formulas. The trade-off is fewer levers in exchange for less maintenance.",
    ],
  ...
  },
  {
    ...
    body: [
      ...
      "In Notespace, PARA maps cleanly to four top-level notebooks. Or skip it - tags and global search are often enough to make PARA's structure unnecessary.",
    ],
  ...
  },
  {
    ...
    body: [
      ...
      "Notespace works well as a Second Brain because capture is fast, search is global, and notes export to plain Markdown. Nothing is locked in.",
    ],
  ...
  },
  {
    ...
    body: [
      ...
      "Notespace doesn't ship a spaced-repetition algorithm. The Flashcards template gives you a place to draft cards; export to Anki or Mochi when you're ready.",
    ],
  ...
  },
  {
    ...
    body: [
      ...
      "Notespace uses standard Markdown plus a handful of common extensions (tables, task lists, fenced code blocks). Every note exports to a .md file you can open in Obsidian, VS Code, or plain Notepad.",
    ],
    related: ["pkm"],
  },
  {
    ...
    body: [
      ...
      "Roam Research popularized backlinks in the modern note-taking world; Obsidian followed; most serious PKM apps now ship them. Notespace uses tags for the same job - lighter weight, less powerful, but enough for most workflows.",
    ],
  ...
  },
  {
    ...
    body: [
      ...
      "BuJo is paper-first by design. The handwriting is the point - it slows you down enough to think. Digital adaptations exist (including a template in Notespace) but lose some of the original benefit.",
    ],
  },
];
