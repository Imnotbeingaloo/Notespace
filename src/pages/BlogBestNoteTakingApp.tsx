...
const jsonLd = [
  {
    ...
    mainEntityOfPage: "https://notespace.lovable.app/blog/best-note-taking-app-2026",
  },
  {
    "@context": "https://schema.org",
    "@type": "FAQPage",
      ...
      <div className="min-h-screen bg-background text-foreground">
        ...
        <article className="blog-article max-w-3xl mx-auto px-6 pt-32 pb-24">
          ...
          <div className="border-t border-border pt-10 mt-10 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Notespace is free to start. Real markdown export. Sync that works. AI that explains, not autowrites.
            </p>
            <Link
              to={CTA}
