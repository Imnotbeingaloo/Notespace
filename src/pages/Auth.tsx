  ...
  return (
    <div className="min-h-dvh grid lg:grid-cols-[42fr_58fr] bg-background relative overflow-hidden">
      ...
      <div className="flex items-center justify-center px-4 py-8 lg:p-10 xl:p-14 relative overflow-hidden order-1 bg-[hsl(43_40%_92%)] dark:bg-background">
        ...
        <div
          aria-hidden="true"
          className="hidden lg:block pointer-events-none absolute inset-y-0 right-0 w-px z-30 bg-border"
        />
            ...
            <div key={mode} className="mx-auto max-w-[400px] animate-in fade-in slide-in-from-bottom-2 duration-300">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className={`w-full flex items-center justify-center gap-3 py-4 rounded-lg border border-foreground/50 bg-muted/60 text-foreground font-medium text-sm hover:bg-muted disabled:opacity-50 ${BTN_PRESS}`}
                >
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-center gap-3 py-4 rounded-lg border border-foreground/50 bg-muted/60 text-foreground font-medium text-sm hover:bg-muted ${BTN_PRESS}`}
                >
      ...
      >
        ...
        <div className="relative z-10 max-w-lg mx-auto text-center w-full">
          ...
          <p className="mt-4 text-[13px] xl:text-sm text-muted-foreground leading-relaxed text-center mx-auto max-w-[500px]">
          ...
          <div className="mt-12 relative max-w-sm mx-auto rotate-[-1.2deg] group cursor-default">
            <div className="rounded-md border border-border/60 bg-card/80 backdrop-blur-sm px-6 py-5 shadow-md transition-all duration-300 ease-out group-hover:-translate-y-1.5 group-hover:rotate-0 group-hover:shadow-xl group-hover:bg-card">
              ...
              <p className="mt-3 text-[10.5px] uppercase tracking-wider text-muted-foreground text-center">
